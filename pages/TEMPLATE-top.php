...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <meta name="description" content="<?=isset($_PMETA["desc"])?$_PMETA["desc"]:"Student Attendance Manager"?>">
    ...
    <div id="cb-body" class="d-flex">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="<?=HOST_BASE?>">
              <i class="mi mi-smol">school</i> Courses
            </a>
          </li>
          <li class="nav-item">
      ...
      <div class="flex-grow-1">
        ...
        <nav class="d-flex bg-dark text-white p-1">
          ...
          <a class="btn btn-sm mi text-white" href="<?=HOST_BASE?>account">
            person
          </a>
